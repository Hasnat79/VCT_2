...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/scratch/user/hasnat.md.abdullah/VCT_2/data/', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='/scratch/user/hasnat.md.abdullah/VCT_2/fake_detection_models/aide/checkpoint/sd14_train.pth',
                        help='resume from checkpoint')
    
    parser.add_argument('--eval_data_path', default="/scratch/user/hasnat.md.abdullah/VCT_2/data/dummy", type=str,
