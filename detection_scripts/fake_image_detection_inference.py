...
if __name__ == "__main__":
    ...
    if args.data_type == 'Wang_CVPR20':
        datasets = {
            'SDXL_coco': '/path/to/your/dataset/COCO/COCO_test_new/SDXL/test',
            'SD21_coco': '/path/to/your/dataset/COCO/COCO_test_new/SD21/test',
            'SD3_coco': '/path/to/your/dataset/COCO/COCO_test_new/SD3/test',
            'DallE3_coco': '/path/to/your/dataset/COCO/COCO_test_new/DallE3/test', 
            'Midjourney_coco': '/path/to/your/dataset/COCO/COCO_test_new/Midjourney/test',  
    ...
    for dataset_name, dataset_path in datasets.items():
        ...
        avg_ap, avg_acc, auc, r_acc, f_acc = evaluate_model(
            args.model_name,
            args.data_type,
            args.mask_type,
            ratio/100,
        ...
        if 0 == 0:
            ...
            with open(f'{results_path}/{filename}', 'a') as file:
                if file.tell() == 0: # Check if the file is empty
                    ...
                    file.write("-" * 28)
                    file.write("\n")
                file.write(f"{dataset_name}, {avg_ap*100:.2f}, {avg_acc*100:.2f}, {r_acc*100:.2f}, {f_acc*100:.2f}, {auc:.3f}\n")
