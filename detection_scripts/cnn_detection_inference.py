...
parser.add_argument('-d','--dir', nargs='+', type=str, default='/path/to/your/dataset/COCO/COCO_test/Midjourney/test')
...
if(not opt.size_only):
  ...
  print('AUC: {:2.2f}, AP: {:2.2f}, Recall: {:2.2f}, Acc (real): {:2.2f}, Acc (fake): {:2.2f}, Acc: {:2.2f}'.format(auc*100., ap*100., recall*100., r_acc*100., f_acc*100., acc*100.))
